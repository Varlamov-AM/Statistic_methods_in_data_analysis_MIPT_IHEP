...
void exercise_02()
{
   ...
   RooRealVar nsig("nsig","#signal events",800,0.,10000) ;
   RooRealVar nbkg("nbkg","#background events",800,0.,10000) ;

   RooAddPdf Double_Gaus("Double_Gaus", "Gaus + Gaus", RooArgList(gauss1, gauss2), RooArgList(nsig,nbkg));
   ...
   RooDataSet *data2 = gauss2.generate(x, 150000);
   RooDataSet *data3 = Double_Gaus.generate(x, 100000);
   ...
   RooPlot *xframe3 = x.frame(Title("2 Gaussian pdf with data"));
   //data3->plotOn(xframe3);
   Double_Gaus.plotOn(xframe3);
